/**
 * Lógica de la cuadrícula de incidencias (/incidencias/).
 * - Auto-submit de filtros (#filtros-incidencias).
 ...
 */
(() => {
  const formularioFiltros = document.getElementById('filtros-incidencias');
