...
from .views import PaymentViewSet, app_index, agregar_pago, actualizar_pago, eliminar_pago, generar_comprobante
...
urlpatterns = [
    ...
    path('actualizar/<uuid:pk>/', actualizar_pago, name='actualizar_pago'),
