/**
 * Lógica de la cuadrícula de solicitudes (/solicitudes/).
 * - Auto-submit de filtros (#filtros-solicitudes).
 ...
 */
(() => {
  const formularioFiltros = document.getElementById('filtros-solicitudes');
